...
while(note !="q" and note !="Q" ):
    ...
    for interval in major_intervals:
        interval_number = major_intervals[interval]
       ...
       # print("Expected note", expected_note)
        ...
        major_scale.append(expected_solution + " ")


    minor_scale = []
    for interval in minor_intervals:
        interval_number = minor_intervals[interval]
        if(interval_number == 1):interval_number+=1
        ...
        for solution in possible_solutions:
            ...
            if solution[0] == expected_note:
                expected_solution = solution
        minor_scale.append(expected_solution + " ")
    print("MAJOR SCALES \n 1: Tonic\n 2: Super Tonic\n 3: Mediant\n 4: Subdominant\n 5: Dominant\n 6: Submediant\n 7: Leading Tone \n 8: Octave or Tonic")
    print("minor scales\n 1: Tonic \n 2: Super Tonic \n 3: Mediant\n 4: Subdominant\n 5: Dominant\n 6: Submediant\n 7: Subtonic \n 8: Octave or Tonic")
    print("Scale Degrees: 1     2     3     4     5     6     7     8")
